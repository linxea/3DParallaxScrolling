...
const CANVAS_LAYERS = [
	{
		image: getImageElement("./images/layer_1_planet.png"),
		z_index: -3.5,
		blend: "normal",
		opacity: 1
	},
	{
		image: getImageElement("./images/layer_2_rocket.png"),
		z_index: -2,
		blend: "normal",
		opacity: 1
	},
	{
		image: getImageElement("./images/layer_3_stripe.png"),
		z_index: -2.5,
		blend: "normal",
		opacity: 0.6
	},
	{
		image: getImageElement("./images/layer_4_monster_shadow.png"),
		z_index: -1.5,
		blend: "multiply",
		opacity: 0.75
	},
	{
		image: getImageElement("./images/layer_5_planet2.png"),
		z_index: -1.2,
		blend: "normal",
		opacity: 1
	},
	{
		image: getImageElement("./images/layer_6_monster.png"),
		z_index: -1,
		blend: "normal",
		opacity: 1
	},
	{
		image: getImageElement("./images/layer_7_monster_cheeks.png"),
		z_index: -0.8,
		blend: "normal",
		opacity: 1
	},
	{
		image: getImageElement("./images/layer_8_monster_hands.png"),
		z_index: -0.3,
		blend: "normal",
		opacity: 1
	},
	{
		image: getImageElement("./images/layer_9_mask.png"),
		z_index: 0,
		blend: "normal",
		opacity: 1
	},
	{
		image: getImageElement("./images/layer_10_float.png"),
		z_index: 1.5,
		blend: "normal",
		opacity: 1
	}
